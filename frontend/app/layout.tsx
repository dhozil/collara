...
export const metadata = { title: "Collara — Reputation Credit", description: "Under-collateralized lending via on-chain reputation. GenLayer Intelligent Contracts. EVM Compatible." }
